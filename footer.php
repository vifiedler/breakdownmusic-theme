...
<!-- ============================================
	 REPRODUCTOR FIJO INFERIOR (con Bootstrap)
	 ============================================ -->
	...
	<div class="bd-player-container d-flex align-items-center gap-3">
		...
		<div class="d-flex align-items-center gap-2 flex-shrink-0" style="min-width:180px;">
			...
			<div class="d-flex flex-column overflow-hidden">
				<span id="bd-player-title" class="text-truncate fw-semibold" style="font-size:0.85rem;">Selecciona una
					canción</span>
				<span id="bd-player-artist" class="text-truncate text-secondary"
					style="font-size:0.75rem;">Artista</span>
			</div>
		</div>
