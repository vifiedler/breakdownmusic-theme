...
<div class="bd-song-card">
    <a href="<?php the_permalink(); ?>" class="d-block text-decoration-none">
        <div class="position-relative">
            <img src="<?php echo esc_url($img_url); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" class="img-fluid w-100 rounded" style="aspect-ratio:1/1;object-fit:cover;">
    ...
    data-post-id="<?php echo get_the_ID(); ?>" 
            ...
            <?php if ($duracion) : ?>
                <span class="position-absolute bottom-0 start-0 m-2 bg-dark bg-opacity-75 text-white px-2 py-1 small rounded"><?php echo esc_html($duracion); ?></span>
            <?php endif; ?>
        </div>
    </a>
    <div class="mt-2">
