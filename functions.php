<?php
/**
 * breakdownmusic-theme functions and definitions
 *
 ...
 */
function breakdownmusic_theme_setup()
{
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on breakdownmusic-theme, use a find and replace
	 * to change 'breakdownmusic-theme' to the name of your theme in all the template files.
	 */
	load_theme_textdomain('breakdownmusic-theme', get_template_directory() . '/languages');
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__('Primary', 'breakdownmusic-theme'),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'breakdownmusic_theme_custom_background_args',
			array(
...
add_action('after_setup_theme', 'breakdownmusic_theme_setup');
 ...
 */
function breakdownmusic_theme_content_width()
{
	$GLOBALS['content_width'] = apply_filters('breakdownmusic_theme_content_width', 640);
}
add_action('after_setup_theme', 'breakdownmusic_theme_content_width', 0);
 ...
 */
function breakdownmusic_theme_widgets_init()
{
	register_sidebar(
		array(
			'name' => esc_html__('Sidebar', 'breakdownmusic-theme'),
			'id' => 'sidebar-1',
			'description' => esc_html__('Add widgets here.', 'breakdownmusic-theme'),
...
add_action('widgets_init', 'breakdownmusic_theme_widgets_init');
...
function breakdownmusic_theme_scripts()
{
	...
	wp_enqueue_script('breakdownmusic-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
